...
[**Recent order notification Magento 2 extension by Magepow**](https://magepow.net/magento-2-recent-order-notification.html) shows beautiful recent sales popups to notify visitors of recently bought items. When you have very small amount of order, you can show fake orders instead to attract customers.
...
### 1. Buy it
  [Buy it on Magepow](https://magepow.net/magento-2-recent-order-notification.html)
